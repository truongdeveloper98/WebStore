    ...
    public class AdministrationController : Controller
    {
        ...
        public async Task<IActionResult> EditRole(EditRoleViewModel model)
        {
            ...
            if (role == null)
            {
                ...
                System.Diagnostics.Debug.WriteLine($"Role ID not found = {model.Id}");
                return NotFound();
            }
            ...
            if (result.Succeeded)
            {
                System.Diagnostics.Debug.WriteLine($"Role with id edited = {model.Id}");
            ...
            foreach (var error in result.Errors)
            {
                System.Diagnostics.Debug.WriteLine($"Unsuccessful audition of the role of the id = {model.Id}");
